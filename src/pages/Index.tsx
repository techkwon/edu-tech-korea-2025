...
import { ChevronRight, Home, Book, Grid2x2, Search, Sparkles, ArrowLeft, ExternalLink, Star, Filter, TrendingUp } from "lucide-react";
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-8 py-16">
          <div className="text-center mb-20">
            <Button
              ...
              variant="ghost"
              className="mb-12 text-gray-300 hover:text-white hover:bg-gray-800/50 rounded-full px-8 py-4 transition-all duration-300 border border-gray-700 backdrop-blur-sm"
            >
            ...
            <div className="space-y-6">
              <h1 className="text-8xl font-extralight tracking-[-0.02em] text-white leading-none">
                EDUTECH
                <span className="block text-6xl font-light text-gray-400 mt-2">COLLECTION</span>
              </h1>
              <div className="w-24 h-[1px] bg-white mx-auto"></div>
              <p className="text-xl text-gray-400 font-light max-w-2xl mx-auto leading-relaxed">
                총 <span className="text-white font-medium">{allItems.length}</span>개의 혁신적인 교육 솔루션
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {allItems.map((item, index) => (
              <Card key={index} className="group bg-white/5 border border-gray-800 rounded-3xl overflow-hidden backdrop-blur-md hover:bg-white/10 transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-white/10">
                <CardHeader className="p-8">
                  <div className="flex items-start gap-4 mb-6">
                    <div className="w-12 h-12 bg-white/10 rounded-2xl flex items-center justify-center backdrop-blur-sm border border-gray-700">
                      <img
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex flex-wrap gap-2">
                        <Badge variant="secondary" className="text-xs px-3 py-1 bg-white/10 text-gray-300 border-gray-700 rounded-full font-light backdrop-blur-sm">{item.대분류}</Badge>
                        <Badge variant="secondary" className="text-xs px-3 py-1 bg-white/10 text-gray-300 border-gray-700 rounded-full font-light backdrop-blur-sm">{item.중분류}</Badge>
                      </div>
                    </div>
                  </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-8 py-16">
          <div className="text-center mb-16">
            <div className="flex gap-4 justify-center mb-12">
              <Button
                onClick={handleBackToCategories}
                variant="ghost"
                className="text-gray-300 hover:text-white hover:bg-gray-800/50 rounded-full px-6 py-3 transition-all duration-300 border border-gray-700 backdrop-blur-sm"
              >
            ...
            <h1 className="text-6xl font-extralight tracking-[-0.02em] text-white mb-2 leading-none">
              {selectedCategory}
            </h1>
          ...
          <div className="space-y-16">
            {Object.entries(items as Record<string, EdutechItem[]>).map(([itemCategory, itemList]) => (
              <div key={itemCategory} className="bg-white/5 rounded-3xl p-10 border border-gray-800 backdrop-blur-md">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                  {itemList.map((item: EdutechItem, index: number) => (
                    <Card key={index} className="group bg-white/5 border border-gray-700 rounded-2xl overflow-hidden backdrop-blur-sm hover:bg-white/10 transition-all duration-300 hover:-translate-y-1">
      ...
      <div className="min-h-screen bg-black text-white">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-8 py-16">
          <div className="text-center mb-20">
            ...
            <h1 className="text-7xl font-extralight tracking-[-0.02em] text-white mb-4 leading-none">
              {selectedCategory}
            </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 max-w-6xl mx-auto">
            {subCategories.map((subCategory, index) => (
              <Card
                key={subCategory}
                className="group cursor-pointer bg-white/5 border border-gray-800 rounded-3xl overflow-hidden backdrop-blur-md hover:bg-white/10 transition-all duration-500 hover:-translate-y-4 hover:shadow-2xl hover:shadow-white/10"
                onClick={() => handleSubCategorySelect(subCategory)}
              >
                <CardHeader className="text-center py-16">
                  <div className="w-20 h-20 bg-white/10 rounded-3xl flex items-center justify-center mx-auto mb-8 group-hover:scale-110 transition-all duration-500 backdrop-blur-sm border border-gray-700">
    ...
    <div className="min-h-screen bg-black text-white overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-8 py-24">
        <div className="text-center mb-32">
          <div className="inline-flex items-center px-6 py-3 bg-white/10 rounded-full border border-gray-700 text-gray-300 text-sm font-light mb-12 backdrop-blur-sm">
            <TrendingUp className="w-4 h-4 mr-3 text-white" />
            2025년 최신 에듀테크 트렌드
          </div>
          
          <div className="space-y-8 mb-20">
            <h1 className="text-9xl font-extralight tracking-[-0.03em] text-white leading-none">
              EDUTECH
            </h1>
          ...
          <p className="text-xl text-gray-400 mb-20 max-w-3xl mx-auto leading-relaxed font-light">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
          {categories.map((category, index) => (
            ...
            >
              <CardHeader className="text-center py-16">
                <div className="relative w-24 h-24 bg-white/10 rounded-3xl flex items-center justify-center mx-auto mb-8 group-hover:scale-110 transition-all duration-500 backdrop-blur-sm border border-gray-700">
        ...
        <div className="text-center mt-32">
          <div className="inline-flex items-center px-8 py-4 bg-white/5 rounded-2xl border border-gray-800 text-gray-400 text-sm backdrop-blur-sm">
